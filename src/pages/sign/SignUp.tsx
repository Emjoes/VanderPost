...
export function SignUp({ onSignUp, onSwitchToLogin }: SignUpProps) {
  ...
  const socialSignUps: SocialSignUpOption[] = [
    {
      id: 'google',
      name: 'Google',
      icon: (
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSignUp({name, email, password, policy, subscribe});
  };
      ...
      <div className="w-full max-w-[32rem]">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={INPUT_LIMITS.authName}
            ...
            {/* Email */}
            <div>
              <label htmlFor="up-email" className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">
                {t("global-email")}
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div>
              <label htmlFor="up-password" className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">
                {t("global-password")}
              </label>
              <div className="relative">
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirm-password" className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">
            ...
            <div className="flex items-start">
              <input
                ...
                className="w-3.5 h-3.5 mt-0.5 rounded border-zinc-300 dark:border-zinc-700 text-blue-600"
                required
              />
              <label htmlFor="terms" className="ml-2 text-xs text-zinc-600 dark:text-zinc-400">
                <Trans
                  ...
                  components={{
                    terms: (
                      ...
                      >
                        <Trans i18nKey="global-terms" context="instr" />
                      </a>
                    ),
                    policy: (
                      <a
                        ...
                        className="text-xs text-blue-600 dark:text-blue-400 hover:underline"
                      >
                        <Trans i18nKey="global-policy" context="instr" />
                      </a>
                    ),
                  }}
                />
            ...
            <div className="flex items-start !mt-2">
              <input
                ...
                className="w-3.5 h-3.5 mt-0.5 rounded border-zinc-300 dark:border-zinc-700 text-blue-600"
              />
              <label htmlFor="newsletter" className="ml-2 text-xs text-zinc-600 dark:text-zinc-400">
                {t("signup-newsletter")}
              </label>
            </div>
